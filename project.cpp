...
public:
    ...
    // friend float get_price1(dept_store &obj,string s);
...
public:
    ...
    // friend void get_price_cafe(cafeteria &,string);
...
public:
    ...
    float hall_fee_func()
    {
        ...
        cout << "Do you want to pay it? (YES/NO)" << endl;
        string s;
        cin >> s;
        if (s == "YES")
        {
    ...
    void update_hall_fee()
    {
        ...
        cout << "Do you want to change it ?(YES/NO)" << endl;
        string s;
        cin >> s;
        if (s == "YES")
        {
    ...
    void show_due_student()
    {
        ...
        for (int i = 0; i < student.size(); i++)
        {
            if (a == student[i].get_roll())
            {
                ...
                string s;
                cout << "Do you want do see all info of that student(YES/NO)" << endl;
                cin >> s;
                if (s == "YES")
                {
...
int main()
{
    ...
    while (1)
    {
        ...
        case 1:
        {
            while (1)
            {
                ...
                cout << "3......Show dues of a Student........." << endl;
                cout << "4.....Pay dues of a student............" << endl;
                cout << "5........Recharge....." << endl;
                cout << "6.......Show Amount...." << endl;
                cout << "7.........Back..........." << endl;
                cout << endl;
                int a1;
                cout << "----Enter your choice----" << endl;
        ...
        case 4:
        {
            while (1)
            {
                ...
                default:
                {
                    cout << "___Invalid Response___" << endl;
                    break;
                }
                }
                if (ss == true)
        ...
        case 6:
        {
            cout << "...This operation is for Employees..." << endl;
            cout << "___Enter your id:__" << endl;
            cout << endl;
            int aaa;
            cin >> aaa;
            string st1;
    ...
    cout << "_____Payment and Management Complete_____" << endl;
    return 0;
}
